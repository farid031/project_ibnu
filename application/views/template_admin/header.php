...
<head>
  ...
  <!-- Favicon -->
  <link href="<?php echo base_url('assets/img/logo_en.png') ?>" rel="icon">
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?php echo base_url('assets/template_admin/bower_components/morris.js/morris.css') ?>">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?php echo base_url('assets/template_admin/bower_components/jvectormap/jquery-jvectormap.css') ?>">
  <!-- Date Picker -->
  <link rel="stylesheet" href="<?php echo base_url('assets/template_admin/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') ?>">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?php echo base_url('assets/template_admin/bower_components/bootstrap-daterangepicker/daterangepicker.css') ?>">
