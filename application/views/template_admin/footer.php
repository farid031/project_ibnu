...
<footer class="main-footer">
    ...
    <strong>Engineer Nusantara</strong>
</footer>
...
<!-- jQuery UI 1.11.4 -->
<script src="<?php echo base_url('assets/template_admin/bower_components/jquery-ui/jquery-ui.min.js') ?>"></script>
...
<!-- Morris.js charts -->
<script src="<?php echo base_url('assets/template_admin/bower_components/raphael/raphael.min.js') ?>"></script>
<script src="<?php echo base_url('assets/template_admin/bower_components/morris.js/morris.min.js') ?>"></script>
<!-- Sparkline -->
<script src="<?php echo base_url('assets/template_admin/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js') ?>"></script>
<!-- jvectormap -->
<script src="<?php echo base_url('assets/template_admin/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js') ?>"></script>
<script src="<?php echo base_url('assets/template_admin/plugins/jvectormap/jquery-jvectormap-world-mill-en.js') ?>"></script>
<!-- jQuery Knob Chart -->
<script src="<?php echo base_url('assets/template_admin/bower_components/jquery-knob/dist/jquery.knob.min.js') ?>"></script>
<!-- daterangepicker -->
<script src="<?php echo base_url('assets/template_admin/bower_components/moment/min/moment.min.js') ?>"></script>
<script src="<?php echo base_url('assets/template_admin/bower_components/bootstrap-daterangepicker/daterangepicker.js') ?>"></script>
<!-- datepicker -->
<script src="<?php echo base_url('assets/template_admin/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') ?>"></script>
<!-- Bootstrap WYSIHTML5 -->
...
<script>
    ...
    function hapusSertifikat(id_cert) {
        Swal.fire({
            title: 'Apakah Anda Yakin?',
            text: "Data sertifikat yang telah dihapus tidak dapat dikembalikan",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('C_admin_sertifikat/delete_sertifikat'); ?>",
                    data: {
                        id_cert: id_cert
                    },
                    success: (data) => {
    ...
    function hapusLearningDetail(id_detail) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('C_admin_learning_detail/delete_learn_detail'); ?>",
                    data: {
                        id_detail: id_detail
                    },
                    success: (data) => {
