<div id="about" class="about" style="background-color: #E3EBE8;">
    <div class="container" align="center" style="background-color: #E3EBE8;">
        <div class=" col-lg-4" style="border: 3px solid #FAC100; padding: 20px; border-radius: 3%; background-color: white;">
            ...
            <div align="left">
                <form enctype="multipart/form-data" action="<?php echo base_url('C_forgot_pass/send_mail') ?>" method="POST">
                    <small>Email</small><br />
                    <input type="email" class=" form-control" name="email" placeholder="Email" width="50%"><br />
                    <div align="right">
                        <input type="submit" value="Send Email" name="submit" class="btn" style="color: black; background-color: #FAC100; border: 1px solid black;">
                    </div>
                </form><br />
                <div align="center">
                    <br />
